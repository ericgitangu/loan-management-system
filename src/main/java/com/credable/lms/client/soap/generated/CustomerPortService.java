 ...
 * 
 */
@WebServiceClient(name = "CustomerPortService", targetNamespace = "http://credable.io/cbs/customer", wsdlLocation = "file:/Users/egitangu/Development/loan-management-system/src/main/resources/wsdl/customerWsdl.wsdl")
public class CustomerPortService
    extends Service
{

    private static final URL CUSTOMERPORTSERVICE_WSDL_LOCATION;
    private static final WebServiceException CUSTOMERPORTSERVICE_EXCEPTION;
    private static final QName CUSTOMERPORTSERVICE_QNAME = new QName("http://credable.io/cbs/customer", "CustomerPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/egitangu/Development/loan-management-system/src/main/resources/wsdl/customerWsdl.wsdl");
